...
if($_GET["txtKeyword"] != "")
	...
	$strSQL = "SELECT * FROM orders WHERE OrderID = '".$_GET["txtKeyword"]."' ";
	...
	?>
	  <tr>
        ...
        <td><?php echo $objResult["or_total"];?></td>
        <td><a href="order-bill-payment-ajax.php?orderid=<?= $objResult["OrderID"];?>">เลือก</a></td>
	  </tr>
	<?php
	}
	?>
...
?>
                ...
                <div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
								...
								<!-- Button -->
								<a href="order-bill-payment-confirm.php?orderid=<?= $objResult["OrderID"]; ?>" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" style="text-decoration:none">
									ยืนยันการชำระเงิน
								</a>
				</div>
	</div>
