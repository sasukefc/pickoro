...
-->
<?php
    $strSQL = "select * from products WHERE pd_id like '".$_GET["pd_id"]. "'";
		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="images/<?php echo $objResult["pd_picture"];?>">
							<div class="wrap-pic-w">
								<img src="images/<?php echo $objResult["pd_picture"];?>" alt="IMG-PRODUCT">
							</div>
						</div>
