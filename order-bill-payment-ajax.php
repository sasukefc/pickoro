...
<?php
        ...
        $qurey = mysqli_query($con, $sql) or die ("Error Query [".$sql."]");
        $data = mysqli_fetch_array($qurey);
?>
<form action="order-bill-payment-comfirm.php" method="post" name="formpayment">
    <div class="form-group">
      <label for="usr">OrderID :</label>
      <label for="usr"><?= $data['OrderID'] ?></label>
      <input type="hidden" name="txtorid" value="<?= $data['OrderID'] ?>">
    </div>
    <div class="form-group">
      <label for="usr">Name :</label>
      <label for="usr"><?= $data['Name'] ?></label>
    </div>
    <div class="form-group">
      <label for="usr">Total :</label>
      <label for="usr"><?= $data['or_total'] ?></label>
    </div>
    <div class="form-group">
      <label for="usr">ใส่ภาพใบเร็จ ATM :</label>
      <input type="file" class="form-control-file" name="txtpic">
    </div>
