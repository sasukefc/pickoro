...
while($objResult2 = mysqli_fetch_array($objQuery2,MYSQLI_ASSOC))
{
	  ...
	  ?>
	  <tr>
		<td><?=$objResult2["pd_id"];?></td>
		<td><?=$objResult3["pd_name"];?></td>
		<td><?=$objResult3["pd_price"];?></td>
...
Sum Total <?=number_format($SumTotal,2);?>
                ...
                <div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
								...
								<!-- Button -->
								<a href="test.php"><button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
									ชำระเงิน
								</button></a>
